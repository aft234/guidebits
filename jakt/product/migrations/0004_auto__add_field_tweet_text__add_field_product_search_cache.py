...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'product_tweet', 'text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.search_cache'
        db.add_column(u'product_product', 'search_cache',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'product_tweet', 'text')

        # Deleting field 'Product.search_cache'
        db.delete_column(u'product_product', 'search_cache')
