...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tweet.name'
        db.add_column(u'product_tweet', 'name',
                      self.gf('django.db.models.fields.CharField')(default='no name', max_length=255),
                      keep_default=False)

        # Adding field 'Tweet.screen_name'
        db.add_column(u'product_tweet', 'screen_name',
                      self.gf('django.db.models.fields.CharField')(default='screenname', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tweet.name'
        db.delete_column(u'product_tweet', 'name')

        # Deleting field 'Tweet.screen_name'
        db.delete_column(u'product_tweet', 'screen_name')
